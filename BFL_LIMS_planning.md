...
└────────────────────┬────────────────────────────────────┘
                     │ SQL
┌────────────────────▼────────────────────────────────────┐
│              MySQL Database (Ubuntu 24)                  │
│  - foodlab DB: 사용자 관리 (30명)                           │
...
| 파일명 | 크기 | 설명 |
|--------|------|------|
| **managers_final.js** | 3 KB | 담당자 33명 (이름, 팀, 직급) |
| **item_manager_mapping.js** | 57 KB | 검사항목 934개 → 담당자 |
| **food_item_manager_mapping.js** | 343 KB | 식품유형+항목 3,823개 → 담당자 |
| **bracket_item_manager_mapping.js** | 126 KB | 괄호+항목 1,438개 → 담당자 |
| **food_item_fee_mapping.js** | ~1 MB | 식품유형+항목 9,237개 → 수수료 (purpose 태그 포함) |
| **ref_nonstandard_data.js** | ~500 KB | 참고용(기준규격외) 항목그룹 3,374개 + 수수료 3,374개 |
...
*본 문서는 2026년 2월 18일 기준으로 최종 업데이트되었으며, 프로젝트 진행에 따라 업데이트됩니다.*
